...
namespace Notifications.Services.UnitTests
{
    public class NotificationsServiceTests
    {
        ...
        private readonly List<NotificationModel> notificationModels;
        private readonly Mock<INotificationsAccess> mockNotificationsAccess;
        private readonly Mock<INotificationTemplatesAccess> mockNotificationTemplatesAccess;
